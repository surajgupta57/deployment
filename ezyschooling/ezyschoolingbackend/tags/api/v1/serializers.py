...
class CustomSkillTagSerializer(serializers.ModelSerializer):
    class Meta:
...
class FeaturedSkillTagSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomSkillTag
        fields = [
            "name",
...
class CustomMustSkillTagSerializer(serializers.ModelSerializer):
    class Meta:
...
class FeaturedMustSkillTagSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomMustSkillTag
        fields = [
            "name",
